...
public class ToolbarPreviewAdapter extends BaseAdapter {
	...
	public ToolbarPreviewAdapter(Context context, MuPDFCore core) {
		...
		File documentCache = new File(StorageUtils.getCacheSubDirectory(mContext, "previews"), MD5.MD5Hash((new File(core.getFileName())).getName()));
...
//		Log.i("William", "getCurrentlyViewing : "+ currentlyViewing);
